...
const BANNERS_DATA: BannerItem[] = [
  {
    ...
    description:
      "Lihat koleksi tak terbatas dari Bimbi Toys yang cocok untuk segala usia. Mulai dari mainan, alat tulis, semua ada!",
    buttonText: "Jelajahi",
    buttonHref: "/#katalog",
  ...
  },
  {
    ...
    description:
      "Langsung lihat barang-barang yang ada di toko melalui website, dan tanyakan langsung via Whatsapp!",
...
export default function HeroBanner() {
  ...
  const activeBanner = BANNERS_DATA[activeIndex];
  ...
  return (
    ...
    >
      {/* =========================
          HERO IMAGE / CAROUSEL
          ========================= */}
      <div className="relative overflow-hidden w-full h-[280px] md:h-auto md:aspect-video lg:aspect-[7780/2978] lg:min-h-0">
        {/* Slides Container */}
        <div
          ...
          {BANNERS_DATA.map((banner) => (
            ...
            >
              {/* =========================
                  ...
                  ========================= */}
              <div className="relative w-full mx-auto max-w-7xl px-4 sm:px-6 py-8 md:py-16 hidden md:block">
              ...
              <div className="md:hidden absolute inset-0 flex items-center">
                <div className="px-5 w-full">
                  <div
                    className={`space-y-3 ${banner.id === 1
                      ? "max-w-[125px]"
                      : "max-w-[190px]"
                      }`}
                  >
                    ...
                    <Link
                      href={banner.buttonHref}
                      className="inline-flex items-center gap-1.5 rounded-full bg-white hover:bg-slate-100 text-bimbi-ink px-4 py-2 font-extrabold text-xs transition-colors shadow-sm"
                    >
                      <span>{banner.buttonText}</span>
