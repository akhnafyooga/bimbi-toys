...
// Glass chip: frosted white over whatever scrolls beneath the sticky header.
const TILE =
  "relative glass-chip flex flex-col items-center justify-center gap-1 rounded-xl py-2.5 px-1 text-[11px] font-bold text-bimbi-ink hover:border-bimbi-pink/50 transition-colors chip-spring";
  ...
  return (
    ...
    >
      ...
      {/* z-10 lifts this whole layer above the category strip inside the
          ...
          here by the glass bar's stacking context — backdrop-filter isolates
          like the old clouds-bg did) paints over it. */}
      ...
      {/* ROW 3 — frosted category strip (sliding, with arrows).
          Folds away on scroll like the logo, leaving a thin rule under
          the search bar. */}
      <div className="header-categories glass-bar w-full border-b border-white/50">
