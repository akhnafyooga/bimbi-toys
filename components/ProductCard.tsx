...
export default function ProductCard({ slug, name, price, compareAtPrice, imageUrl }: Props) {
  ...
  return (
    <Link
      href={`/product/${slug}`}
      className="group block rounded-md bg-white border border-slate-100 hover:border-bimbi-sky/20 p-3.5 transition-all hover:shadow-md duration-300 flex flex-col justify-between"
    >
      <div>
